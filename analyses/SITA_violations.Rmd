...
# tau = 1, nu = 1.0 for prop, nu = 0.2 for prog

```{r}
dat <- lapply(1:10, function(x) read_xSITA_data_1000(x, "../data/SITA_violations/nu_1_prop_02_prog/", 0.2)) %>% bind_rows
```
...
These don't really do what I expect.  Suspect a bug.


# tau = 1, nu = 0.2 for prop, nu = 1 for prog

These don't really do what I expect.  Suspect a bug.

```{r}
dat <- lapply(1:10, function(x) read_xSITA_data_1000(x, "../data/SITA_violations/nu_02_prop_1_prog/", 1 )) %>% bind_rows
```
