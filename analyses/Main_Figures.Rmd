...
dat1 <- lapply(1:10, function(x) read_data_1000(x, "../data/tau_half/nsim_1000/")) %>% bind_rows
dat2 <- lapply(1:10, function(x) read_data_1000(x, "../data/tau_half/nsim_1000/more_sims/")) %>% bind_rows
