...
run_sim <- function(rho = 0.1, p = 10, nsim = 10, out_file = "test_", true_mu = "X1 - 10/3", ks = 1:10, sigma = 1, tau = 0.5, N = 2000) {
  t1 <- proc.time()
  # simulate
...
run_sim(rho = rho, p = p, nsim = nsim, out_file = out_file, sigma = 1, ks = 1:10, N = 2000)
